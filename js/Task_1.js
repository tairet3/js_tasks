//1.Завдання : Генератор випадкових дражнилок (завдання на роботу з масивами)
...
//2.Завдання : за допомоги join перетворити масив [3,2,1] в рядок '3 більше за 2, а 2 більше ніж 1' (P.S. якщо при поєднаннічерез join нам не потрібен символ, 
